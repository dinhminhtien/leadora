...
enum ReminderStatus {
  ...
  static ReminderStatus fromWire(String? raw) => ReminderStatus.values.firstWhere(
        (s) => s.wire == raw,
...
enum ReminderPriority {
  ...
  static ReminderPriority fromWire(String? raw) => ReminderPriority.values.firstWhere(
        (p) => p.wire == raw,
...
class Reminder {
  ...
  bool get isActionable => status == ReminderStatus.pending || status == ReminderStatus.overdue;
