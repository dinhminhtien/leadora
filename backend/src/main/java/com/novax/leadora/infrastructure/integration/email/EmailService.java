    ...
    public void sendResetPasswordHtmlEmail(String toEmail, String resetLink) {
        try {
            ...
            String htmlMsg = "<div style=\"font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 550px; margin: auto; padding: 25px; border: 1px solid #e2e8f0; border-radius: 16px; background-color: #ffffff;\">"
                    ...
                    "    Hello,<br><br>" +
                    "    We received a request to reset the password for your Leadora account. Click the button below to secure your account and set a new password:"
                    +
                    "  </p>" +
                    "  <div style=\"text-align: center; margin: 25px 0;\">" +
                    "    <a href=\"" + resetLink
                    + "\" style=\"display: inline-block; background-color: #2563eb; color: #ffffff; text-decoration: none; padding: 11px 24px; font-size: 13px; font-weight: 700; border-radius: 8px; box-shadow: 0 4px 6px -1px rgba(37, 99, 235, 0.2);\">Reset Password</a>"
                    +
                    "  </div>" +
                    "  <p style=\"color: #475569; font-size: 12px; line-height: 1.6;\">" +
                    "    Or copy and paste this link into your browser:<br>" +
                    "    <a href=\"" + resetLink + "\" style=\"color: #2563eb; word-break: break-all;\">" + resetLink
                    + "</a>" +
                    "  </p>" +
