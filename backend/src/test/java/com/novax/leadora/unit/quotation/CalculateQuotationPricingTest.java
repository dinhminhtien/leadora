...
class CalculateQuotationPricingTest {
    ...
    @Test
    @DisplayName("UT-QUOTATION-PRICING-01: Subtotal calculation for 3 nights and 2 rooms")
    ...
    @Test
    @DisplayName("UT-QUOTATION-PRICING-02: Discount calculation at 15%")
    ...
    @Test
    @DisplayName("UT-QUOTATION-PRICING-03: Zero discount returns exact subtotal")
