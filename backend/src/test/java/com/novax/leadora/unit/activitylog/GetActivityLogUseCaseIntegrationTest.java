...
@SpringBootTest
@ActiveProfiles("dev")
@Disabled("Disabled by default as it requires a live PostgreSQL connection to Supabase. Enable manually for integration testing.")
    ...
    void testEffectiveViewQuery() {
        ...
        try {
            ...
            Page<String> mapped = result.map(entity -> {
                if (entity.getActorType() == com.novax.leadora.infrastructure.persistence.entity.enums.ActorType.USER && entity.getActorUser() != null) {
