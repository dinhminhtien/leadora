    ...
    <div className="flex flex-col gap-1">
      <div className="relative flex items-center">
        ...
        <input
          ref={ref}
          type={type}
          className={`w-full rounded-xl border border-border bg-input py-2 px-3.5 text-sm text-foreground placeholder:text-muted-foreground/60 shadow-[inset_0_1.5px_3px_rgba(0,0,0,0.025)] focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/10 disabled:cursor-not-allowed disabled:opacity-50 dark:shadow-none ${icon ? "pl-10" : "pl-4"
