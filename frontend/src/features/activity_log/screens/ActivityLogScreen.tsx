      ...
      <Card className="border-zinc-200 dark:border-zinc-800 shadow-sm bg-zinc-50/50 dark:bg-zinc-950/20">
        <CardContent className="p-4 flex flex-wrap gap-4 items-center">
          ...
          <button
            ...
            className="px-3 py-2 text-xs text-zinc-500 hover:text-zinc-800 dark:hover:text-zinc-200 border border-zinc-200 dark:border-zinc-850 bg-white dark:bg-zinc-900 hover:bg-zinc-50 dark:hover:bg-zinc-850 rounded-lg transition shadow-sm font-semibold flex items-center gap-1"
          >
              ...
              {logs.map((log) => {
                ...
                return (
                  <TableRow key={log.id} className="hover:bg-zinc-50 dark:hover:bg-zinc-900/40 border-b border-zinc-100 dark:border-zinc-900 transition">
                    <TableCell className="py-3 px-4 text-xs font-medium text-zinc-500 dark:text-zinc-400 whitespace-nowrap">
                      ...
                      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-3">
                        <div>
                          ...
                          <div className="flex flex-wrap items-center gap-x-3 gap-y-1 mt-2 text-[11px] text-zinc-500">
                            <span>Actor: <strong className="text-zinc-700 dark:text-zinc-300">{log.actor.fullName}</strong> {log.actor.role && `(${log.actor.role})`}</span>
                            <span>•</span>
        ...
        {totalPages > 1 && (
          <div className="flex items-center justify-between px-5 py-4 border-t border-zinc-100 dark:border-zinc-900 bg-zinc-50/50 dark:bg-zinc-950/20">
            <p className="text-xs text-zinc-500 dark:text-zinc-400">
              Page <strong className="text-zinc-800 dark:text-zinc-200">{page + 1}</strong> of <strong className="text-zinc-800 dark:text-zinc-200">{totalPages}</strong>
              <span className="text-zinc-400 dark:text-zinc-600 ml-2">· {totalElements} audit entries</span>
            </p>
                    ...
                    <>
                      ...
                      {selectedLog.recordOperation !== "NORMAL" && (
                        <div className={`flex items-start gap-2.5 p-3.5 border rounded-xl text-[11px] ${selectedLog.recordOperation === "VOIDED"
                            ? "bg-rose-50 border-rose-200 dark:bg-rose-950/10 dark:border-rose-900/60 text-rose-800 dark:text-rose-400"
                            : "bg-amber-50 border-amber-200 dark:bg-amber-950/10 dark:border-amber-900/60 text-amber-800 dark:text-amber-400"
                          }`}>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="border border-zinc-100 dark:border-zinc-900 rounded-xl p-4 bg-white dark:bg-zinc-950 space-y-3">
                          <div className="grid grid-cols-2 gap-3 text-xs">
                            <div>
                              <span className="text-[10px] text-zinc-400 dark:text-zinc-500 block">Action Category</span>
                              <span className={`px-2 py-0.5 rounded text-[10px] font-semibold uppercase tracking-wide border inline-block ${actionCat.color}`}>
                                {actionCat.label}
                              </span>
                            </div>
                            <div>
                              <span className="text-[10px] text-zinc-400 dark:text-zinc-500 block">Action Event Code</span>
                              <strong className="text-zinc-700 dark:text-zinc-300 font-mono text-[11px]">{selectedLog.activityType}</strong>
                            </div>
                            <div className="col-span-2">
                              <span className="text-[10px] text-zinc-400 dark:text-zinc-500 block mb-1">State / Operation Mode</span>
                              <Badge variant={opCfg.variant} className="font-extrabold text-[9px] uppercase tracking-wide">
                                {opCfg.label}
                              </Badge>
                            </div>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="border border-zinc-100 dark:border-zinc-900 rounded-xl p-4 space-y-3 bg-white dark:bg-zinc-950">
                          <div className="grid grid-cols-2 gap-3 text-xs">
                            <div>
                              <span className="text-[10px] text-zinc-400 dark:text-zinc-500 block">Actor Type</span>
                              <strong className="text-zinc-700 dark:text-zinc-300">{selectedLog.actor.type}</strong>
                            </div>
                            <div>
                              <span className="text-[10px] text-zinc-400 dark:text-zinc-500 block">Actor Name</span>
                              <strong className="text-zinc-700 dark:text-zinc-300">{selectedLog.actor.fullName}</strong>
                            </div>
                            {selectedLog.actor.id && (
                              <div>
                                <span className="text-[10px] text-zinc-400 dark:text-zinc-500 block">Actor User ID</span>
                            ...
                            {selectedLog.actor.role && (
                              <div>
                                <span className="text-[10px] text-zinc-400 dark:text-zinc-500 block">Role Snapshot</span>
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="border border-zinc-100 dark:border-zinc-900 rounded-xl p-4 bg-white dark:bg-zinc-950">
                          <div className="grid grid-cols-2 gap-3 text-xs">
                            <div>
                              <span className="text-[10px] text-zinc-400 dark:text-zinc-500 block">Entity Type</span>
                            ...
                            <div>
                              <span className="text-[10px] text-zinc-400 dark:text-zinc-500 block">Entity ID</span>
                      ...
                      <div className="space-y-2">
                        ...
                        {selectedLog.payload ? (
                          ...
                          <div className="p-4 border border-zinc-100 dark:border-zinc-900 rounded-xl text-center text-xs text-zinc-400 bg-zinc-50/50 dark:bg-zinc-900/30">
